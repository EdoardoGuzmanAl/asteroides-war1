 ...
 if( lives >= 0 && asteroids.size()>0){
   ...
   if(darkCounter < darkCounterLimit){
    ...
    rect(0,0,width,height);
     ...
     textFont(font, 33);
     fill(0, 200);
     text("HAS PERDIDO ", width/2-80-2, height*.75-1);
     textFont(font, 32);
     fill(255);
     text("perdiste vuelve a intentar ", width/2-80, height*.75);

     textFont(font, 16);
     fill(0, 200);
     text("Has click en el mouse para jugar de nuevo", width/2-80-2, height*.9-1);
     textFont(font, 15);
     fill(255);
     text("Has click en el mouse para jugar de nuevo", width/2-80, height*.9);
   }
 } else {
     background(0);
     ship = new Ship();
     ...
     fill(255);
     if(stage > -1){
         text("combate  " + (stage + 1) + " Completo", width/2-120, height/2);
     } else {
         text("asteroid war ", width/2-80, height/2);
     }

     textFont(font, 15);
     fill(255);
     text("Has click en el mousesi si estas preparado " + (stage + 2), width/2-100, height*.75);
